...
public class UserControllerTest {
        ...
        public void testProcessRegisterFormSuccess(String name, String email, String phone, LocalDate birthDate,
                        String province, String postCode, String genres, String username, String password,
                        Boolean enabled, Boolean accept, String confirmPassword) throws Exception {
                User user = new User(name, email, phone, birthDate, province, postCode, genres, username, password,
                                enabled, accept, confirmPassword);
                ...
                requestJson = requestJson.replace("null",
        ...
        public void testGetProvinces() throws Exception {
                List<String> provinces = Arrays.asList(ProvinceEnum.values()).stream().map(x -> x.toString())
                                .collect(Collectors.toList());
                this.mockMvc.perform(get("/provinces")).andExpect(status().isOk())
                                .andExpect(jsonPath("$.provinces").value(provinces));
        }
