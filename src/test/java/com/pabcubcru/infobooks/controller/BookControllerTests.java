...
public class BookControllerTests {
    ...
    void setup() {
        ...
        BDDMockito.given(this.requestService.findFirstByIdBook1AndStatus(ID_BOOK_1, RequestStatus.ACEPTADA.toString()))
                .willReturn(null);
        BDDMockito.given(this.requestService.findFirstByIdBook2AndStatus(ID_BOOK_1, RequestStatus.ACEPTADA.toString()))
                .willReturn(null);
    ...
    public void testMain() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/books/new")).andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void testMainWithSecurity() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/books/{id}", ID_BOOK_1))
                .andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("Main"));
    }
     ...
     * @Test
     * 
     * @WithMockUser(value = "test001", authorities="usuario") public void
     * testMainWithUserSecurity() throws Exception {
     ...
     * 
     * @WithMockUser(value = "test001", authorities = "usuario") public void
     * testPostEditBook() throws Exception {
     * this.mockMvc.perform(MockMvcRequestBuilders.put("/books/{id}/edit",
     * ID_BOOK_1).with(SecurityMockMvcRequestPostProcessors.csrf()) .param("id",
     * ID_BOOK_1).param("title", "Title").param("isbn",
     * "0-7645-2641-3").param("originalTitle", "") .param("publicationYear",
     * "2015").param("publisher", "Publisher").param("genres", "Comedia,Aventuras")
     * .param("author", "Author").param("description", "Description").param("image",
     * "https://i.ibb.co/YRy9kHC/paper.jpg") .param("status",
     * "POCO USADO").param("action", "INTERCAMBIO").param("price",
     * "").param("username", "")) .andExpect(MockMvcResultMatchers.status().isOk());
     * }
     */
     ...
     * @Test
     * 
     * @WithMockUser(value = "user1", authorities = "usuario") public void
     * testPostCreateBook() throws Exception {
     * this.mockMvc.perform(MockMvcRequestBuilders.post("/books/new").with(
     * SecurityMockMvcRequestPostProcessors.csrf()) .param("title",
     * "Title").param("isbn", "0-7645-2641-3").param("originalTitle", "")
     * .param("publicationYear", "2015").param("publisher",
     * "Publisher").param("genres", "Comedia,Aventuras") .param("author",
     * "Author").param("description", "Description").param("image",
     * "https://i.ibb.co/YRy9kHC/paper.jpg") .param("status",
     * "POCO USADO").param("action", "INTERCAMBIO").param("price", ""))
     * .andExpect(MockMvcResultMatchers.status().isOk()); }
     */
    ...
    public void testPostCreateBookError() throws Exception {
        this.mockMvc
                .perform(MockMvcRequestBuilders.post("/books/new").with(SecurityMockMvcRequestPostProcessors.csrf())
                        .param("title", "Title").param("isbn", "0-7645-2641-3").param("publicationYear", "2015")
                        .param("publisher", "Publisher").param("genres", "Comedia,Aventuras").param("author", "Author")
                        .param("description", "Description").param("image", "https://i.ibb.co/YRy9kHC/paper.jpg")
     ...
     * @Test
     * 
     * @WithMockUser(value = "test002", authorities = "usuario") public void
     * testDeleteBook() throws Exception {
     * this.mockMvc.perform(MockMvcRequestBuilders.delete("/books/{id}/delete",
     * ID_BOOK_2)) .andExpect(MockMvcResultMatchers.status().is2xxSuccessful()); }
     */
     ...
     * 
     * @WithMockUser(value = "test001", authorities = "usuario") public void
     * testListAllExceptMyBooks() throws Exception {
