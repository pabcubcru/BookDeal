...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		"/books/{id}/edit", "/books/new", "/books/{id}/delete", "/books/list/me", "/books/list/me-change", "/books/edit/{id}", "/books/images/upload").authenticated()
		.antMatchers("/books/list/all-me", "/books/{id}", "/books/get/{id}", "/books/all/{page}", "/books/genres", "/search").permitAll()
