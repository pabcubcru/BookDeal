...
export default class List extends Component {
  ...
  async getUser(username) {
    ...
    render() {
        return (
            <div>
              <h1 style={{float:"left", color: "black"}}><b>Mis peticiones</b></h1><br></br><br></br><br></br>
              {this.state.requests.length == 0 ?
                ...
                <center>
                  ...
                  {this.state.pages.length > 1 ? 
                    <center><br></br>{this.state.actualPage != 0 ? <a class="btn btn-primary" href={"/requests/me/"+parseInt(this.state.actualPage-1)}>Anterior</a> : <p></p>}
