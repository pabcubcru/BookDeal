...
export default class List extends Component {
      ...
      <div>
        ...
        {this.state.requests.length == 0 ? (
          <div>
            <p>
              <strong>
                ¿No has recibido peticiones todavía?{" "}
          ...
          return (
            ...
            >
              ...
              {request.action == "INTERCAMBIO" ? (
                ...
                <center>
                  <a href={"/books/" + this.state.books2[i].id}>
                    <img
              ...
              <center>
                ...
                {request.status != "ACEPTADA" ? (
                  <p>
                    <strong>Petición enviada por: </strong>
                    {request.username1}
                  </p>
                ) : (
                  <p></p>
              ...
              {request.status == "PENDIENTE" ? (
                <center>
                  ...
                  <a
                    onClick={() =>
                      this.rejectRequest(request.id, this.state.actualPage)
                    }
                ...
                <center>
                  <p>
                    <strong>
                      <i>
                        <u>Datos de contacto con {request.username1}</u>
                      </i>
                    </strong>
                  </p>
                  <p>
          ...
          <center>
            {this.state.actualPage != 0 ? (
              <a
                class="btn btn-primary"
                href={
                  "/requests/received/" + parseInt(this.state.actualPage - 1)
                }
              >
                Anterior
              </a>
  ...
  async acceptRequest(id, title, actualPage) {
    const conf = confirm(
      "¿Está seguro de que quiere aceptarla? Las otras peticiones a " +
        title +
        " se rechazarán."
    );
    if (conf) {
  ...
  async rejectRequest(id, actualPage) {
    const conf = confirm(
      "¿Está seguro de que quiere rechazarla? Esta acción no es reversible."
    );
    if (conf) {
