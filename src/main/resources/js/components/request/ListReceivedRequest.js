            ...
            <div>
              {this.state.requests.length == 0 ?
                ...
                {this.state.requests.map((request, i) => {
                    ...
                    backgroundSize: "auto auto", padding: "30px", paddingTop:"20px", marginBlock:"30px", margin:"0px 20px 20px 0px", width: request.action == "VENTA" ? "300px" : "380px", height: '480px', display:"inline-grid"}}>
