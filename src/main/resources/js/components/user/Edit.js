...
export default class Form extends Component {
  ...
  render() {
    return (
      ...
      >
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input
              type="password"
              class="form-control"
              placeholder="Debe contener entre 8 y 20 carácteres"
        ...
        {
          <p style={{ color: "#099C01" }}>
            {this.state.messageCorrectPassword}
          </p>
        }
        ...
        <div class="form-group row">
          <div class="col-sm-6">
            <button
              ...
              type="submit"
              disabled={
                this.state.fieldPassword.length < 8 ||
                this.state.fieldPassword.length > 20 ||
                this.state.fieldConfirmPassword.length < 8 ||
                this.state.fieldConfirmPassword.length > 20
              }
            >
              Cambiar
            </button>
  ...
  async onClickSave() {
    ...
    if (res.success) {
      if (
        this.state.fieldPassword != "" &&
        this.state.fieldConfirmPassword != ""
      ) {
        this.setState({
