...
export default class Home extends Component {
    ...
    render() {
      return (
        ...
        <h1 style={{fontFamily:"cursive", fontStyle:"italic"}}>a InfoBooks,</h1><br></br><h2 style={{fontFamily:"cursive", fontStyle:"italic"}}>tu web preferida de intercambio y compra venta de libros.</h2><br></br>
