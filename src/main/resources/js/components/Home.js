...
export default class Home extends Component {
    ...
    render() {
      return (
        <center><div style={{borderRadius: '5px', backgroundImage: "url(https://i.ibb.co/YRy9kHC/paper.jpg)", backgroundSize: "cover" }}>
        <img width="400px" height="400px" src="https://i.ibb.co/vXSqB6W/logo.png"></img>
